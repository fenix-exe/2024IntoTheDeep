...
public class EndEffectorPresetPosition {
    ...
    public static EndEffectorPresetPosition INTAKE_POSITION = new EndEffectorPresetPosition(-45,90);
    public static EndEffectorPresetPosition DEPOSIT_FRONT_TOP_BUCKET_POSITION = new EndEffectorPresetPosition(-90,90);
    public static EndEffectorPresetPosition DEPOSIT_FRONT_BOTTOM_BUCKET_POSITION = new EndEffectorPresetPosition(-90,90);
