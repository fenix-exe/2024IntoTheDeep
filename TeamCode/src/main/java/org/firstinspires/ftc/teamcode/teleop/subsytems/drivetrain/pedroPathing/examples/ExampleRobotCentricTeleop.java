package org.firstinspires.ftc.teamcode.teleop.subsytems.drivetrain.pedroPathing.examples;
...
public class ExampleRobotCentricTeleop extends OpMode {
    ...
    public void init() {
        ...
        FollowerConstants.maxPower = 0.5;
    ...
    public void loop() {
        ...
        *
        ...
        if ((Math.abs(gamepad1.left_stick_y) > 0.5 || Math.abs(gamepad1.left_stick_x) > 0.5 || Math.abs(gamepad1.right_stick_y) > 0.5) && !manualMode){
            follower.startTeleopDrive();
            manualMode = true;
        }
