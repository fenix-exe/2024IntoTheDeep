...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 2153.206627708316; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -1972.942846123326; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -959.9126080379651; // x position of the perpendicular encoder (in tick units)
    }
