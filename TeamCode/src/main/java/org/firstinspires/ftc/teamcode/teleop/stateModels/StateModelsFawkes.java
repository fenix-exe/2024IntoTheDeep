...
public class StateModelsFawkes {
    ...
    public static void initialize(Arm arm, Wrist wrist, Claw claw, DriverControls driverControls){
        StateModelsFawkes.arm = arm;
        StateModelsFawkes.wrist = wrist;
        StateModelsFawkes.driverControls = driverControls;
        StateModelsFawkes.claw = claw;
